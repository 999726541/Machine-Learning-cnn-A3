...
sgd = SGD(lr=0.01, decay=0.9, momentum=0.9, nesterov=True) # replace 'rmsprop'
...
model.fit_generator(
        ...
        nb_val_samples=2100)
model.save_weights('leo_2.h5')  # always save your weights after training or during training